package com.sibu.xinweishang.builder.template;
...
import com.sibu.xinweishang.common.builder.BuidSpringUtil;
import com.sibu.xinweishang.common.builder.bean.BuilderBean;
import com.sibu.xinweishang.common.builder.bean.FieldBean;
import com.sibu.xinweishang.common.builder.bean.JavaCodeBean;
import com.sibu.xinweishang.common.builder.util.AutoCompleteUtil;
...
public class Builder {
	...
	static {
		...
		/** 源码根目录 */
		builderBean.setSrcPath(System.getProperty("user.dir") + File.separator + "src"  + File.separator + "main"+ File.separator + "java");
		/** 设置使用标签作为字段名 */
		...
		builderBean.setCover(false);
		/** 模板代码存放的主包名 */
		builderBean.setTemplateMainPackageName("com.sibu.builder.template");
		/** 生成代码存放的主包名 */
		builderBean.setTargetMainPackageName("com.sibu.orderHelper.api");
		
		// TODO 在这里修改必要参数  
		/** 作者 */ 
		builderBean.setAuthor("xiaoheliu");
		/** 主名字 */
		builderBean.setMyName("user");
		/** 表名 */
		builderBean.setTableName("user");
		/** ID名 */
		builderBean.setIdName("user_id");
