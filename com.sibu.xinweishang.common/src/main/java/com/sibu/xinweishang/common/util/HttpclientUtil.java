...
public class HttpclientUtil {
	...
	public static String get(String url, Map<String, String> params,
		...
		if (url == null || StringUtil.isNull(url)) {
			return null;
		}
	...
	public static String post(String url, Map<String, String> params,
		...
		try {
			if (charset == null || StringUtil.isNull(charset)) {
	...
	/**
	 * 
	* @Title: setCookieStore 
	* @Description: 在请求头里面添加cookie
	* @author xiaoheliu
	* @date 2016年1月19日 下午4:42:46
	* @param @param httpResponse    设定文件 
	* @return void    返回类型 
	* @throws
	 */
